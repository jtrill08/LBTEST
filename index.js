...
jobNode.querySelector(".job-apply a").setAttribute("target", "_blank");
    ...
    if (storedData) {
        storedData.forEach(data => {
            ...
            notificationNode.innerHTML = `<div class="notification-job-company">${data.jobCompany}</div>
                                          ...
                                          <div class="notification-job-apply"><a href=${data.jobApply}>Apply</a></div>
    ...
    if(localStorage.getItem("notifications")) {
        ...
        notifications.forEach((notification, index) => {
            ...
            notificationNode.innerHTML = `<div class="notification-job-company">${notification.jobCompany}</div>
                 ...
                 <div class="notification-job-apply"><a href="${notification.jobApply}" target="_blank">Apply</a></div>
...
function notify(button) {
    ...
    notificationNode.innerHTML = `<div class="notification-job-company">${jobCompany}</div>
                                  ...
                                  <div class="notification-job-apply"><a href=${jobApply}>Apply</a></div>
